...
CREATE TABLE IF NOT EXISTS "public"."activities" (
    ...
    CONSTRAINT "activities_related_type_check" CHECK ((("related_type" IS NULL) OR ("related_type" = ANY (ARRAY['customer'::"text", 'sale'::"text", 'purchase_order'::"text", 'asset'::"text", 'repair_job'::"text", 'invoice'::"text", 'vendor'::"text", 'recurring_expense'::"text", 'marketing_asset'::"text"])))),
