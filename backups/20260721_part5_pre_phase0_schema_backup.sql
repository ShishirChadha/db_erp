...
CREATE TABLE IF NOT EXISTS "public"."asset_ledger" (
    ...
    CONSTRAINT "asset_ledger_source_check" CHECK (("source" = ANY (ARRAY['purchase_order'::"text", 'legacy_purchase'::"text"]))),
    CONSTRAINT "asset_ledger_status_check" CHECK (("status" = ANY (ARRAY['draft'::"text", 'reserved'::"text", 'received'::"text", 'in_stock'::"text", 'sold'::"text", 'faulty'::"text", 'returned'::"text", 'qc_pending'::"text", 'qc_passed'::"text", 'ready_for_sale'::"text", 'rma_sent'::"text", 'rma_returned'::"text", 'scrapped'::"text"]))),
