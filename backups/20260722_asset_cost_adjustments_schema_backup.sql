...
CREATE OR REPLACE FUNCTION "public"."sync_accessory_stock_from_movement"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
  cur_qty integer;
begin
  select quantity into cur_qty from public.accessories where id = new.accessory_id for update;
  if cur_qty is null then
    raise exception 'Accessory % not found', new.accessory_id;
  end if;

  new.quantity_before := cur_qty;
  new.quantity_after := cur_qty + new.quantity_change;

  if new.quantity_after < 0 then
    raise exception 'Not enough stock for this accessory (have %, tried to remove %)', cur_qty, -new.quantity_change;
  end if;

  update public.accessories set quantity = new.quantity_after where id = new.accessory_id;
  return new;
end;
$$;


ALTER FUNCTION "public"."sync_accessory_stock_from_movement"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."accessories" (
    ...
    CONSTRAINT "accessories_review_status_check" CHECK (("review_status" = ANY (ARRAY['active'::"text", 'pending_review'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."accessory_movements" (
    ...
    CONSTRAINT "accessory_movements_movement_type_check" CHECK (("movement_type" = ANY (ARRAY['in'::"text", 'out'::"text", 'adjustment'::"text", 'return_in'::"text"])))
);


ALTER TABLE "public"."accessory_movements" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."purchase_order_asset_mapping" AS
 SELECT "id",
    "po_id",
    "po_item_id",
    "sku_id",
...
ALTER VIEW "public"."purchase_order_asset_mapping" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."accessory_movements"
    ADD CONSTRAINT "accessory_movements_pkey" PRIMARY KEY ("id");
...
CREATE OR REPLACE TRIGGER "trg_sync_accessory_stock" BEFORE INSERT ON "public"."accessory_movements" FOR EACH ROW EXECUTE FUNCTION "public"."sync_accessory_stock_from_movement"();
...
ALTER TABLE ONLY "public"."accessory_movements"
    ADD CONSTRAINT "accessory_movements_accessory_id_fkey" FOREIGN KEY ("accessory_id") REFERENCES "public"."accessories"("id");



ALTER TABLE ONLY "public"."accessory_movements"
    ADD CONSTRAINT "accessory_movements_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."accessory_movements"
    ADD CONSTRAINT "accessory_movements_sale_id_fkey" FOREIGN KEY ("sale_id") REFERENCES "public"."sales"("id");
...
ALTER TABLE ONLY "public"."repair_job_parts"
    ADD CONSTRAINT "repair_job_parts_accessory_id_fkey" FOREIGN KEY ("accessory_id") REFERENCES "public"."accessories"("id");



ALTER TABLE ONLY "public"."repair_job_parts"
    ADD CONSTRAINT "repair_job_parts_accessory_movement_id_fkey" FOREIGN KEY ("accessory_movement_id") REFERENCES "public"."accessory_movements"("id");
...
ALTER TABLE ONLY "public"."sales"
    ADD CONSTRAINT "sales_accessory_id_fkey" FOREIGN KEY ("accessory_id") REFERENCES "public"."accessories"("id");
...
CREATE POLICY "accessory_movements_authenticated" ON "public"."accessory_movements" USING (("auth"."role"() = 'authenticated'::"text")) WITH CHECK (("auth"."role"() = 'authenticated'::"text"));
...
GRANT ALL ON FUNCTION "public"."sync_accessory_stock_from_movement"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_accessory_stock_from_movement"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_accessory_stock_from_movement"() TO "service_role";
...
GRANT ALL ON TABLE "public"."accessory_movements" TO "anon";
GRANT ALL ON TABLE "public"."accessory_movements" TO "authenticated";
GRANT ALL ON TABLE "public"."accessory_movements" TO "service_role";
