...
CREATE TABLE IF NOT EXISTS "public"."profile_page_actions" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "profile_page_actions_page_key_check" CHECK (("page_key" = ANY (ARRAY['new_entry'::"text", 'accessories'::"text", 'repair_jobs'::"text", 'sku_master'::"text", 'live_stock'::"text", 'invoices'::"text", 'customers'::"text", 'activities'::"text"])))
);
...
GRANT ALL ON FUNCTION "public"."prevent_self_tier_change"() TO "anon";
GRANT ALL ON FUNCTION "public"."prevent_self_tier_change"() TO "authenticated";
