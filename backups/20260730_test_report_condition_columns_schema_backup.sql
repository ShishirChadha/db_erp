...
COMMENT ON VIEW "public"."public_product_units" IS 'Anon-safe per-unit QC info for the product page "this exact unit" card. Never select qc_by (staff uuid) or qc_notes (internal shorthand) here.';
...
ALTER TABLE ONLY "public"."cart_items"
    ADD CONSTRAINT "cart_items_customer_id_sku_id_key" UNIQUE ("customer_id", "sku_id");
