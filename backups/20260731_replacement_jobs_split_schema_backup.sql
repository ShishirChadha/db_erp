...
CREATE TABLE IF NOT EXISTS "public"."profile_page_actions" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "profile_page_actions_page_key_check" CHECK (("page_key" = ANY (ARRAY['new_entry'::"text", 'accessories'::"text", 'repair_jobs'::"text", 'sku_master'::"text", 'live_stock'::"text", 'invoices'::"text", 'customers'::"text", 'activities'::"text", 'sales'::"text", 'stock'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "contact_email" "text",
    "employee_id" "text",
    CONSTRAINT "profiles_allowed_pages_check" CHECK (("allowed_pages" <@ ARRAY['new_entry'::"text", 'accessories'::"text", 'repair_jobs'::"text", 'sku_master'::"text", 'live_stock'::"text", 'invoices'::"text", 'customers'::"text", 'activities'::"text", 'sales'::"text", 'stock'::"text"])),
