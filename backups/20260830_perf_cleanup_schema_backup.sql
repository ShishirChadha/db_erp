...
CREATE TABLE IF NOT EXISTS "public"."profile_page_actions" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "profile_page_actions_page_key_check" CHECK (("page_key" = ANY (ARRAY['new_entry'::"text", 'accessories'::"text", 'repair_jobs'::"text", 'replacement_jobs'::"text", 'sku_master'::"text", 'live_stock'::"text", 'invoices'::"text", 'customers'::"text", 'activities'::"text", 'sales'::"text", 'stock'::"text", 'website'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    CONSTRAINT "profiles_allowed_pages_check" CHECK (("allowed_pages" <@ ARRAY['new_entry'::"text", 'accessories'::"text", 'repair_jobs'::"text", 'replacement_jobs'::"text", 'sku_master'::"text", 'live_stock'::"text", 'invoices'::"text", 'customers'::"text", 'activities'::"text", 'sales'::"text", 'stock'::"text", 'website'::"text"])),
...
CREATE INDEX "advisor_queries_created_idx" ON "public"."advisor_queries" USING "btree" ("created_at" DESC);



CREATE INDEX "advisor_queries_misses_idx" ON "public"."advisor_queries" USING "btree" ("created_at" DESC) WHERE ("matched_resolver" IS NULL);
...
CREATE INDEX "backup_snapshots_trigger_type_idx" ON "public"."backup_snapshots" USING "btree" ("trigger_type");
...
CREATE INDEX "kb_chapters_body_trgm_idx" ON "public"."kb_chapters" USING "gin" ("body_md" "extensions"."gin_trgm_ops");
...
CREATE INDEX "kb_chapters_title_trgm_idx" ON "public"."kb_chapters" USING "gin" ("title" "extensions"."gin_trgm_ops");
...
CREATE POLICY "advisor_queries_select_owner" ON "public"."advisor_queries" FOR SELECT TO "authenticated" USING ("public"."is_owner"());
...
CREATE POLICY "replacement_job_counter_authenticated" ON "public"."replacement_job_counter" USING (("auth"."role"() = 'authenticated'::"text")) WITH CHECK (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "replacement_job_parts_authenticated" ON "public"."replacement_job_parts" USING (("auth"."role"() = 'authenticated'::"text")) WITH CHECK (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "replacement_jobs_authenticated" ON "public"."replacement_jobs" USING (("auth"."role"() = 'authenticated'::"text")) WITH CHECK (("auth"."role"() = 'authenticated'::"text"));
