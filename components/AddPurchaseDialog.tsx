    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-full max-w-[90vw] md:max-w-4xl lg:max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {isDesktop && (
                <>
                  ...
                  <div className="flex items-center space-x-2"><Checkbox id="has_keyboard" checked={formData.has_keyboard} onCheckedChange={(v) => handleChange("has_keyboard", !!v)} /><Label htmlFor="has_keyboard">Keyboard Included?</Label></div>
                  <div className="flex items-center space-x-2"><Checkbox id="has_mouse" checked={formData.has_mouse} onCheckedChange={(v) => handleChange("has_mouse", !!v)} /><Label htmlFor="has_mouse">Mouse Included?</Label></div>
                </>
              )}
              <div className="flex items-center space-x-2"><Checkbox id="charger" checked={formData.charger} onCheckedChange={(v) => handleChange("charger", !!v)} /><Label htmlFor="charger">Charger Included?</Label></div>
          ...
          {/* Expense Section */}
          <div className="border rounded-lg p-4 space-y-4">
            <div className="flex items-center space-x-2"><Checkbox id="expense" checked={formData.expense} onCheckedChange={(v) => handleChange("expense", !!v)} /><Label htmlFor="expense">Any extra expense incurred?</Label></div>
            {formData.expense && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
