      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div><Label>Purchase Date</Label><Input type="date" value={formData.purchase_date?.slice(0,10) || ""} onChange={(e) => handleChange("purchase_date", e.target.value)} /></div>
            <div>
              <Label>Vendor</Label>
              <Select value={formData.vendor_id || ""} onValueChange={(val) => handleChange("vendor_id", val)}>
                ...
                <SelectContent>
                  {vendors.map(v => (
                    <SelectItem key={v.id} value={v.id} className="truncate">{v.company_name}</SelectItem>
                  ))}
                </SelectContent>
              </Select>
            ...
            <div><Label>Brand</Label><Input value={formData.brand || ""} onChange={(e) => handleChange("brand", e.target.value)} /></div>
            <div><Label>Model</Label><Input value={formData.model || ""} onChange={(e) => handleChange("model", e.target.value)} /></div>
          ...
          {(formData.type === "Laptop" || formData.type === "Desktop" || formData.type === "Tiny") && (
            <div className="border rounded-lg p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div><Label>RAM</Label><Input value={formData.ram || ""} onChange={(e) => handleChange("ram", e.target.value)} /></div>
                <div><Label>SSD/HDD</Label><Input value={formData.ssd || ""} onChange={(e) => handleChange("ssd", e.target.value)} /></div>
                <div className="flex items-center space-x-2">
          ...
          {isDesktop && (
            <div className="border rounded-lg p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div><Label>Monitor Size (inches)</Label><Input value={formData.monitor_size || ""} onChange={(e) => handleChange("monitor_size", e.target.value)} placeholder="e.g., 24, 27" /></div>
                <div className="flex items-center space-x-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2"><Label>Asset Description</Label><Input value={formData.asset_description || ""} onChange={(e) => handleChange("asset_description", e.target.value)} /></div>
            ...
            <div><Label>Total Price (Auto)</Label><Input type="number" step="0.01" value={formData.total_price ?? ""} disabled className="bg-gray-100" /></div>
