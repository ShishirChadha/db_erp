...
Full plan: `~/.claude/plans/i-want-to-design-wondrous-kurzweil.md`; build record: `docs/decisions.md` (2026-07-28 entries). Not yet built: reviews, related/recently-viewed products, blog, a real WhatsApp/enquiry channel, product comparison, and any admin-side order-management UI in the ERP itself (orders are currently only visible to the customer who placed them, on the website).
